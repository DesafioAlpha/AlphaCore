...
class DA_Model_Dbtable_Event extends Zend_Db_Table_Abstract
{
    protected $_name  = 'event';
    protected $_primary = 'event_id';
    
    /**
     * Retorna uma lista de todos os eventos da tabela
     * 
     * @throws Exception
     * @return array
     */
    ...
    {
        $select = $this->select()
                       ->from($this, array('start_date', 'end_date', 'title', 'description'));
